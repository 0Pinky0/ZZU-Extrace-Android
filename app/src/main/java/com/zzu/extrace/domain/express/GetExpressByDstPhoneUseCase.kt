...
class GetExpressByDstPhoneUseCase {
    operator fun invoke(
        phone: String
    ): Response<Express> = runBlocking {
        ...
        val response: Response<Express> = client.get(GetUrlUseCase("/express/get_by_dst_phone/${phone}")).body()
        client.close()
