...
class GetAllExpressUseCase {
    operator fun invoke(): Response<List<Express>> = runBlocking {
        ...
        val response: Response<List<Express>> = client.get(GetUrlUseCase("/express")).body()
        client.close()
        response
    }
}